...
describe('Add-Spend: component', () => {
  ...
  beforeEach(() => {
    ...
    spyOn(component.spenditureService, 'add').and.returnValue(Observable.of(spending));

    fixture.detectChanges();
  });

  it('should match with two way binding Spenditure made', done => {
    ...
    component.spenditureService.add(component.spending).subscribe(toCheck => {
  ...
  it('should call server when button clicked', done => {
    let element = fixture.nativeElement;
    ...
    element.querySelector('#add-button').dispatchEvent(new Event('click'));

    expect(component.spenditureService.add).toHaveBeenCalled();
